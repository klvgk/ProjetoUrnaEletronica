...
//Inicia e prepara interface das Etapas de Votação;
...
//Ações ao clicar nos numeros do teclado;
function clicou(n) {
...
function branco() {
    if (numero === '') {
        ...
        alert("Para votar em BRANCO, não pode ter digitado nenhum número! Aperte 'Corrige'.");
    }
};
